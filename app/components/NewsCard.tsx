  ...
  return (
    <Link href={href} className="block">
      <div className="relative rounded-[28px] overflow-hidden transition-all duration-300 hover:-translate-y-2 h-[420px] md:h-[480px]">
        ...
        <span className="absolute top-4 right-4 w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center z-10" style={{ backgroundColor: v.btnBg }}>
        ...
        <div className="absolute top-[60%] left-0 right-0 bottom-0 rounded-b-2xl px-5 py-5 md:px-8 md:py-8 z-10" style={{ backgroundColor: v.bg, boxShadow: `0 20px 60px 20px ${glowColor}` }}>
