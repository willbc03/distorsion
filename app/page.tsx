...
const noticiasPorGenero = {
  ...
  ciencia: [
    { id: 10, title: "Vacuna nasal contra virus y alergias", titleEn: "Nasal vaccine against viruses and allergies", description: "Investigadores presentaron una vacuna experimental que activa defensas frente a virus, bacterias y alérgenos.", descriptionEn: "Researchers presented an experimental vaccine that activates defenses against viruses, bacteria and allergens.", href: "/noticia/10", image: "/vacuna1.jpg", imagePosition: "center center" },
    { id: 11, title: "Eclipse lunar teñirá la Luna de rojo", titleEn: "Lunar eclipse will turn the Moon red", description: "El 3 de marzo de 2026 la Luna adquirirá un tono rojizo visible en distintas partes del mundo.", descriptionEn: "On March 3, 2026 the Moon will turn reddish and be visible across different parts of the world.", href: "/noticia/11", image: "/lunar1.jpg", imagePosition: "center center" },
    { id: 12, title: "Mascotas y salud: vivir con perros", titleEn: "Pets and health: living with dogs", description: "Estudios sugieren que convivir con perros podría mejorar indicadores de bienestar físico y mental.", descriptionEn: "Studies suggest that living with dogs could improve physical and mental wellbeing indicators.", href: "/noticia/12", image: "/perros1.jpg", imagePosition: "center center" },
  ],
};
